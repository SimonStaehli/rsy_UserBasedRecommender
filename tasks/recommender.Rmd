...
rand_top_movies_spars = calc_sparsity(coerce(MoviesLense_random_user_top_movies_df, MovieLense))
...
Lorem ipsum ...
```{r}
intersect_over_union(as.matrix(Movies_random_selected_df), as.matrix(MoviesLense_random_user_top_movies_df))
```
...
eval_random <- recommenderlab::evaluationScheme(data = coerce(Movies_random_selected_df, MovieLense), 
...
eval_random_user_top_movies <- recommenderlab::evaluationScheme(data = coerce(MoviesLense_random_user_top_movies_df, MovieLense), 
                                                method="split", train=0.8, given=3)
...
similarity_mat[similarity_mat < 0.0000001] <- NA
similarity_mat
```
...
reduced_binär <- binarize(train_test_reduced[[1]], minRating=2)

Recommender_model_IBCF_jaccard <- Recommender(data = train_test_reduced[[1]], method='IBCF', parameter=list(method='Jaccard',k=30))
Recommender_model_UBCF_jaccard <- Recommender(data = train_test_reduced[[1]], method='UBCF', parameter=list(method='Jaccard',nn=30))
...
```{r}
Recommender_model_SVD_10 <- Recommender(data = train_test_reduced[[1]], method = "SVD", parameter = list(k = 10))
Recommender_model_SVD_20 <- Recommender(data = train_test_reduced[[1]], method = "SVD", parameter = list(k = 20))
Recommender_model_SVD_30 <- Recommender(data = train_test_reduced[[1]], method = "SVD", parameter = list(k = 30))
Recommender_model_SVD_40 <- Recommender(data = train_test_reduced[[1]], method = "SVD", parameter = list(k = 40))
Recommender_model_SVD_50 <- Recommender(data = train_test_reduced[[1]], method = "SVD", parameter = list(k = 50))

NUM_RECOMMENDATIONS <- 15

Recommender_model_SVD_10_top15 <-  predict(Recommender_model_SVD_10, newdata=test, n=NUM_RECOMMENDATIONS)
Recommender_model_SVD_20_top15 <-  predict(Recommender_model_SVD_20, newdata=test, n=NUM_RECOMMENDATIONS)
Recommender_model_SVD_30_top15 <-  predict(Recommender_model_SVD_30, newdata=test, n=NUM_RECOMMENDATIONS)
Recommender_model_SVD_40_top15 <-  predict(Recommender_model_SVD_40, newdata=test, n=NUM_RECOMMENDATIONS)
Recommender_model_SVD_50_top15 <-  predict(Recommender_model_SVD_50, newdata=test, n=NUM_RECOMMENDATIONS)
