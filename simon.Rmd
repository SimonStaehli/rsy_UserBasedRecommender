...
Beim Punkteplot ist ein Vergleich schwierig weil die Countwerte grundsätzlich stark unterschiedlich und abhängig von 
dem Genre sind. Dennoch kann man sehen wo die Nutzer absolut die meisten Ratings abgesetzt haben.
Dies sind vor allem Action und Drama Filme. Bei allen Filmen tendiert die Mehrheit der Ratings eher grösser
...
Die Mittleren Filmbewertung bewegen sich in der Mitte, respektive bei 3. Im mittleren Feld existiern
die meisten Bewertung, zwischen 2 und 4. Es gibt ausserordnelich wenig FIlme, die im Schnitt eine Bewertung von 5
haben. Handkerum gibt es viele Filme die eine Durchschnittliche Bewertung von 1 haben. Dies müsste jedoch noch mit der Anzahl der vorhanden Kundenbewertungen von den Filmen verglichen werden, da die sehr irreführend sein könnte.
...
Auch hier zeigt sich das gleiche Bild wie bei dden mittleren Raatings bereits geshene. Die meisten
Nutzerbewertungen sind um 3-4 herum.
